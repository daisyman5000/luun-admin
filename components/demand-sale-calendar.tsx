    ...
    <section className="rounded-[28px] border border-line bg-white p-5 shadow-sm">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Vancouver inventory plus container invoice inventory, minus inventory already planned to sell.
          </p>
        </div>
      ...
      <div className="mt-5 rounded-3xl border border-line bg-slate-50 p-4">
        ...
        <div className="mt-3 grid gap-3 lg:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] lg:items-stretch">
          ...
          <div className="hidden items-center text-2xl font-semibold text-slate-400 lg:flex">-</div>
          <Stat label="Already planned sold" value={wholeNumber(totalBreakdown(plan.defaultSale.plannedSoldBeforeMonthByType))} />
          <div className="hidden items-center text-2xl font-semibold text-slate-400 lg:flex">=</div>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-2xl border border-line bg-white p-4">
            <p className="text-xs font-semibold uppercase tracking-normal text-slate-500">Sold before month</p>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <Stat label="Max orders" value={plan.defaultSale.orders === null ? "Unavailable" : wholeNumber(plan.defaultSale.orders)} />
        <Stat label="Max revenue" tone="strong" value={plan.defaultSale.maxRevenue === null ? "Unavailable" : money(plan.defaultSale.maxRevenue)} />
